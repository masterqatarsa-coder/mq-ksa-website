...
$contactEmail = getenv('CONTACT_EMAIL') ?: 'info@qatarmaster.com';
...
$success = sendSMTPEmail($contactEmail, $subject, $emailBody, $headers, $smtpHost, $smtpPort, $smtpUsername, $smtpPassword);
